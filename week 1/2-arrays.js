...
console.log("The car with an id of 33 ...")
...
console.log('The last car in their inventory')
console.log(lastCar);
...
let carModelsSorted = inventory.sort((a,b)=>{
...
console.log("The car model names into alphabetical order");
...
getYear();
console.log("All the years from every car on the inventory");
...
console.log("The cars that are made before the year 2000 ...")
console.log(oldCars);
...
console.log("BMW and Audi cars only within the inventory")
console.log(result);
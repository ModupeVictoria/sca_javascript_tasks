...
console.log("The first and last names of each runner for their running bibs.")
console.log(fullNames); 

// ==== Challenge 2: Use .map() ====
// The event director needs to have all the runners' first names in uppercase because the director BECAME DRUNK WITH POWER. Populate an array called `firstNamesAllCaps`. This array will contain just strings.
let firstNamesAllCaps = [];
firstNamesAllCaps.push(runners.map(firstName));
function firstName(value){
 let Caps = value.first_name;
 allCaps = Caps.toUpperCase();
 return allCaps;
}
console.log("All the runners' first names in uppercase")
console.log(firstNamesAllCaps);

// ==== Challenge 3: Use .filter() ====
// The large shirts won't be available for the event due to an ordering issue. We need a filtered version of the runners array, containing only those runners with large sized shirts so they can choose a different size. This will be an array of objects.
let runnersLargeSizeShirt = [];
runnersLargeSizeShirt.push(runners.filter(largeSize));
function largeSize(value){
  if(value.shirt_size = "L"){
  return value;  
  }
}
console.log("Runners with large sized shirts")
console.log(runnersLargeSizeShirt);

// ==== Challenge 4: Use .reduce() ====
// The donations need to be tallied up and reported for tax purposes. Add up all the donations and save the total into a ticketPriceTotal variable.
console.log("Addition of all the donations")
let ticketPriceTotal = runners.reduce(function (total,value) 
{return total + value.donation;},0);
...
console.log("List of all the runners' email")
console.log(email); 
// Problem 2
let companyName = [];
runners.forEach(companyNames);
function companyNames(value){
companyName.push(value.company_name)
}
console.log("List of all the runners' Company Name")
console.log(companyName); 
// Problem 3
let details = [];
runners.forEach(Details);
function Details(value){
details.push("This is " + value.first_name + " " + value.last_name + " " + "with Email " +  value.email + " " + " and Company Name" + value.company_name)
}
console.log("List of all the runners' details")
console.log(details); 